...
const ErrorMessage: React.FC<ErrorMessageProps> = ({ message }) => {
  return (
    <div className="bg-red-50 dark:bg-red-900/30 border-l-4 border-red-400 dark:border-red-500 text-red-700 dark:text-red-300 p-4 rounded-lg shadow" role="alert">
      <div className="flex">
        <div className="py-1">
